...
public class Etudiant extends Utilisateur {
	...
	@ManyToMany(mappedBy = "etudiants", fetch = FetchType.LAZY, cascade = { CascadeType.PERSIST, CascadeType.DETACH,
	...
	public Etudiant(String nom, String prenom, String adresse, String username, String password, String sexe,
			Date date_nais, String email, String cNE, String cIN, String filiere, String tele, String niveau_Scolaire) {
